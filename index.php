...
?>
        <section class = "main-container">
          <div class="main-wrapper">
            ...
            <br>
            <p>
              You can check out the current top 10 players in the list below!
            </p>
          </div>
        </section>
        ...
        <section class = "main-container">
          <div class="main-wrapper">
            ...
            <?php
              ...
              $sql = "select name, email, rank, phone, username
                from player order by rank limit 10;";
            ...
            <!--Options to search and challenge others-->
            <?php
              if (isset($_SESSION['u_name']))
              {
                // Create a form for the user to use to interact with the database...
                echo '
                  <p>Interact with the database using the various options below!</p>
                  <br>
                  <ul>
                    <li><b><a href="challenge.php">Challenge Other Players</a></b></li>
                    <br>
                    <li><b><a href="accept_reject.php">Accept/Reject Challenges</a></b></li>
                    <br>
                    <li><b><a href="game.php">Report Match Game Scores & Update Ladder Rankings</a></b></li>
                    <br>
                    <li><b><a href="delete.php">Leave The Ladder</a></b></li>
                  </ul>';
              }
              else
              {
